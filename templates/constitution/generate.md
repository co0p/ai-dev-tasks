...
You are tasked with generating a fully self-contained `create-constitution.prompt.md` file for the 4DC project. Use the contents of all files in the `/templates/constitution` folder (including frontmatter.md, persona.md, process.md, pillars.md, output.md, interaction.md) as source material.
