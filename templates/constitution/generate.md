...
You are tasked with generating a fully self-contained `create-constitution.prompt.md` file for the 4DC project. Use the contents of all files in the `/templates/constitution` folder (including frontmatter.md, persona.md, goal.md, process.md, pillars.md, output.md, interaction.md, style.md, glossary.md, acceptance.md, constraints.md, examples.md, schema-hints.md) as source material.
...
- Immediately after the frontmatter, merge all relevant details from persona.md, goal.md, process.md, pillars.md, output.md, interaction.md, style.md, glossary.md, acceptance.md, constraints.md, examples.md, and schema-hints.md.
- Do not reference or link to any external files or folders in the output.
- The resulting prompt must include the persona, goal, process, pillars, output format, interaction style, writing style, glossary, acceptance checklist, context constraints template, examples library, and JSON schema hints directly in the file.
